    ...
    new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [
          ...
          { label: 'High', data: high, borderColor: 'green', backgroundColor: 'rgba(0,128,0,0.2)', fill: true, tension: 0.3 },
  ...
  .then(data => {
    ...
    new Chart(ctx_remote, {
      ...
      options: {
        ...
        maintainAspectRatio: false,
        scales: {
          x: { title: { display: false, text: 'Site' } },
          y: { title: { display: true, text: 'Net CO2e Removals' } }
        },
        plugins: {
          legend: { display: true },
...
function showBioTotal() {
 ...
 fetch('./pages/totalBiomass.json')
  ...
  .then(data => {
    ...
    const midLow = data.map(d => d["Net Co2e Removals Mid Low"]);
    const low = data.map(d => d["Net Co2e Removals Low"]);
    const obs = data.map(d => d["Net Co2e Removals Observed"]);
    ...
    new Chart(ctx_obs, {
      ...
      data: {
        ...
        datasets: [
          ...
          { label: 'Mid Low', data: midLow, borderColor: 'orange', backgroundColor: 'rgba(255,165,0,0.2)', fill: false, tension: 0.3 },
          { label: 'Low', data: low, borderColor: 'red', backgroundColor: 'rgba(255,0,0,0.2)', fill: false, tension: 0.3 },
          { label: 'Observed', data: obs, backgroundColor: 'rgba(219, 22, 206, 0.91)', fill: true, tension: 0.3 },
      ...
      options: {
        ...
        scales: {
          x: { title: { display: true, text: 'Year' } },
          y: { title: { display: true, text: 'Net CO2e Removals' }, min:0 }
        },
        plugins: {
          legend: { display: true },
          tooltip: {
