...
function showTanzContent() {
  //toggle off
  const off = [philConBtn, malConBtn, brazConBtn, canvaConBtn];
  off.forEach(element => {
  ...
  // hide/show section
  const hide = [philCon, malCon, brazCon, canvaCon];
...
function showPhilContent() {
  //toggle off
  const off = [tanzConBtn, malConBtn, brazConBtn, canvaConBtn];
  off.forEach(element => {
      element.classList.remove("active-side");
      element.classList.add("off-side");
  });
  ...
  on.classList.add("active-side");
  // hide/show section
  const hide = [tanzCon, malCon, brazCon, canvaCon];
    hide.forEach(element => {
        element.style.display = "none";
    });
    const show = philCon;
...
function showMalContent() {
  //toggle off
  const off = [philConBtn, tanzConBtn, brazConBtn, canvaConBtn];
  off.forEach(element => {
      element.classList.remove("active-side");
      element.classList.add("off-side");
  });
  ...
  on.classList.add("active-side");
  // hide/show section
  const hide = [philCon, tanzCon, brazCon, canvaCon];
    hide.forEach(element => {
        element.style.display = "none";
    });
    const show = malCon;
...
function showBrazContent() {
  //toggle off
  const off = [philConBtn, malConBtn, tanzConBtn, canvaConBtn];
  off.forEach(element => {
      element.classList.remove("active-side");
      element.classList.add("off-side");
  });
  ...
  on.classList.add("active-side");
  // hide/show section
  const hide = [philCon, malCon, tanzCon, canvaCon];
    hide.forEach(element => {
        element.style.display = "none";
    });
    const show = brazCon;
    ...
    .then(data => {
      ...
      haChartInstanceCanva = new Chart(haBarCtxCanva, {
          ...
          data: {
            ...
            datasets: [
              {
                label: 'Forecasted Acres Planted',
                data: reportedCanva,
