...
function showSchedulePhil() {
  //toggle underline
  const off = [pLogBtnPhil, speciesBtnPhil, stakeBtnPhil];
  off.forEach(element => {
  ...
  // hide/show section
  const hide = [pLogPhil, speciesPhil, stakePhil];
...
function showLogPhil() {
  // toggle underline
  const off = [scheduleBtnPhil, speciesBtnPhil, stakeBtnPhil];
  off.forEach(element => {
    element.classList.remove("active-link");
  });
  ...
  // hide other sections
  const hide = [schedulePhil, speciesPhil, stakePhil];
  hide.forEach(element => {
    element.style.display = "none";
  });
...
function showSpeciesPhil() {
  //toggle underline
  const off = [scheduleBtnPhil, pLogBtnPhil, stakeBtnPhil];
  off.forEach(element => {
      element.classList.remove("active-link");
  });
  ...
  on.classList.add("active-link");
  // hide/show section
  const hide = [schedulePhil, pLogPhil, stakePhil];
    hide.forEach(element => {
        element.style.display = "none";
    });
...
function showStakeholdersPhil() {
  //toggle underline
  const off = [scheduleBtnPhil, pLogBtnPhil, speciesBtnPhil];
  off.forEach(element => {
      element.classList.remove("active-link");
  });
  ...
  on.classList.add("active-link");
  // hide/show section
  const hide = [schedulePhil, pLogPhil, speciesPhil];
    hide.forEach(element => {
        element.style.display = "none";
    });
