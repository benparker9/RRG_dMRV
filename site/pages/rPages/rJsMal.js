...
document.addEventListener("DOMContentLoaded", function () {
  ...
  fetch('./rPages/haSiteMal2.json').then(r=>r.json()).then(data=>{
    ...
    window.haChartInstanceMal2 = new Chart(haBarCtx2,{
      ...
      data:{labels:sites2,datasets:[
        {label:'Capacity of Site',data:reported2,backgroundColor:'#c1e3aa'},
        {label:'Hectares Claimed Restored',data:verified2,backgroundColor:'#627c49'}
      ]},
  ...
  fetch('./rPages/treeSiteMal2.json').then(r=>r.json()).then(data=>{
    ...
    window.treeChartInstanceMal2 = new Chart(treeBarCtx2,{
      type:'bar',
      data:{labels:sites3,datasets:[{label:'Capacity of Site',data:reported3,backgroundColor:'#c1e3aa'},{label:'Trees Planted to Date',
